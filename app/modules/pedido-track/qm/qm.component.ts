...
export class QmComponent extends TrackBaseComponent implements OnInit{
  tipoOperacao = TipoOperacaoTrack.qm;
  funcionalidade = FuncionalidadeConfiguracaoUsuario.Qm;
