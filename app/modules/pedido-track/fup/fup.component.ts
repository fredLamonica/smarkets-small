...
export class FupComponent extends TrackBaseComponent implements OnInit{
  tipoOperacao = TipoOperacaoTrack.fup;
  funcionalidade = FuncionalidadeConfiguracaoUsuario.Fup;
