...
export abstract class FiltroLateralMarketplaceComponent extends Unsubscriber implements OnInit, OnChanges {

  @Input() filtro: FiltroMarketplace;
  @Input() ativo: boolean;
  @Output() filtroChange: EventEmitter<FiltroLateralMarketplace> = new EventEmitter<FiltroLateralMarketplace>();
  ...
  limparTodosFiltros() {
    this.filtro = Object.assign(this.filtro, { filtroLateral: new FiltroLateralMarketplace() });
