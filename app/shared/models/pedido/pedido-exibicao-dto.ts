...
import { PedidoItemProdutoDto } from './pedido-item-produto-dto';
import { PedidoItemServicoDto } from './pedido-item-servico-dto';
import { PedidoObservacaoPadrao } from './pedido-observacao-padrao';

export class PedidoExibicaoDto {
  idPedido: number;
  codigo: string;
  idUsuario: number;
  usuario: Usuario;
  ...
  itensProduto: Array<PedidoItemProdutoDto>;
  itensServico: Array<PedidoItemServicoDto>;
  ...
  constructor(init?: Partial<PedidoExibicaoDto>) {
