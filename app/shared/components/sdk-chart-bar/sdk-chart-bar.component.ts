...
@Component({
  selector: 'sdk-chart-bar',
  templateUrl: './sdk-chart-bar.component.html',
  styleUrls: ['./sdk-chart-bar.component.scss']
})
export class SdkChartBarComponent implements OnInit {
  ...
  ngOnInit() {
    this.construirGraficoBar();
  }

  public construirGraficoBar() {
